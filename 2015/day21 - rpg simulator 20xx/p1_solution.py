...
def find_minimum_cost_to_win():
    ...
    for items in generate_item_combinations():
        ...
        if does_player_win(PLAYER_HIT_POINTS, total_damage, total_armor, BOSS_HIT_POINTS, BOSS_DAMAGE, BOSS_ARMOR):
            min_cost = min(min_cost, total_cost)

    return min_cost

# Execute the solution
result = find_minimum_cost_to_win()
print(result)
# answer is 111
